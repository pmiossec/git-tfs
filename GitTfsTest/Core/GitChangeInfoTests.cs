...
namespace Sep.Git.Tfs.Test.Core
{
    public class GitChangeInfoTests : BaseTest
    {
        ...
        [Fact]
        public void IgnoreCaseOnlyRenames()
        {
            string input =
                ":100644 100644 ab6422c94fcb11e61378a231b0f3ce36958206d4 bb6422c94fcb11e61378a231b0f3ce36958206d4 R100\0TestFiles/Test0.txt\0TestFiles/Test_moved.txt\0" +
                ":100644 100644 aaaac94fcb11e61378a231b0f3ce36958206d4dd bbbb22c94fcb11e61378a231b0f3ce36958206d4 R100\0TestFiles/Test1.txt\0TestFiles/test1.txt\0" +
                ":100644 100644 fb6422c94fcb11e61378a231b0f3ce36958206d4 fb6422c94fcb11e61378a231b0f3ce36958206d4 R100\0TestFiles/Test2.txt\0TestFiles/test2.txt\0";
        ...
        [Fact]
        public void IgnoreCaseOnlyDeletes()
        {
            string input =
                ":000000 100644 0000000000000000000000000000000000000000 ed61b923604692e7c8b14763bd94412f471d91cc A\0TestFiles/Test0.txt\0" +
            ...
            using (var reader = new System.IO.StringReader(input))
            {
                ...
                Assert.Equal("D", changes[1].Status);
                Assert.Equal("TestFiles/Test1.txt", changes[1].path);

                Assert.Equal("A", changes[2].Status);
                Assert.Equal("TestFiles/Test2.txt", changes[2].path);
            }
        }
    }
